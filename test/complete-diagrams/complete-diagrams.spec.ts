...
describe('complete-diagrams', () => {
  ...
  it('complete-computer-network', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-computer-network.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-dependency-diagram', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-dependency-diagram.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-diagram1', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-diagram1.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-diagram2', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-diagram2.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-dropshadows', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-dropshadows.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-flowchart1', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-flowchart1.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-flowchart2', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-flowchart2.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-movies', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-movies.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-organization-chart', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-organization-chart.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
  ...
  it('complete-organization-chart-new', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-organization-chart-new.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
    await expect(pdf.output('arraybuffer')).toMatchPdfSnapshot('./complete-organization-chart-new.pdf')
  })

  it('complete-social-network', async () => {
    const { svgElement, width, height } = await loadSvg('/test/complete-diagrams/complete-social-network.svg')
    const pdf = new jsPDF(width > height ? 'l' : 'p', 'pt', [width, height])
    await svg2pdf(svgElement, pdf, { loadExternalStyleSheets: true })
